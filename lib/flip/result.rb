class Flip
  # Flip response object, a wrapper for raw response object plus helper methods
  #
  # Usual response body for Flip.charge or Flip.status will look like this:
  #
  #   {
  #     "status_code": "200",
  ...
  class Result
    ...
    attr_reader :time
    # Request full URL, e.g. "https://api.sandbox.flip.com/v2/charge"
    attr_reader :url
    ...
    def initialize(response, url, request_options, time)
      begin
        ...
        Flip.logger.info "Error parsing Flip response #{e.message}"
        Flip.logger.info e.backtrace.join("\n")
        @data = {}
      end
    ...
    # Docs https://api-docs.flip.com/#status-code
    def status_code
